    ...
    <div id="AboutUs">
      <div className="pt-16 pb-7 bg-[#E9F7DC] ">
        ...
        >
          ...
          small group of experts offering honest and comprehensive guidance on
          and service for course selection, university admission, university
        ...
        >
          <div className="sm:flex sm:flex-row sm:gap-5">
            ...
            >
              ...
              <div className="lg:text-[14px] xl:text-[16px]  text-center">
                We offer genuine and up-to-date information on studies in
                foreign countries
              </div>
            </motion.div>
          </div>
