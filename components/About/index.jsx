...
const About = () => {
  ...
  return (
    <div className=" py-5  bg-green-100">
      <div className={`text-[#083C82] text-[39px] text-center font-bold ${libreBaskerville.className}`}>
        About Valley Journey
      </div>
      <div className={`text-[26px] justify-center pb-5 px-20 ${aleo.className}`}>
      ...
      <div className={`flex justify-between px-10 gap-5 pb-5 ${lora.className}`}>
